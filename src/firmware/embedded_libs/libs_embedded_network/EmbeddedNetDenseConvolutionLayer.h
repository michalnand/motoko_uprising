#ifndef _EMBEDDED_NET_DENSE_CONVOLUTION_LAYER_H_
#define _EMBEDDED_NET_DENSE_CONVOLUTION_LAYER_H_

#include <EmbeddedNetLayer.h>

class EmbeddedNetDenseConvolutionLayer: public EmbeddedNetLayer
{
    private:
    ...
    public:
        EmbeddedNetDenseConvolutionLayer(
        ...
        virtual ~EmbeddedNetDenseConvolutionLayer();
